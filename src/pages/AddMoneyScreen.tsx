        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-end justify-center">
            <div className="w-full max-w-md bg-white dark:bg-slate-900 rounded-t-2xl p-6 shadow-xl animate-slide-up">
                <div className="flex justify-between items-center mb-4">
                    <h2 className="text-xl font-bold text-black dark:text-white">Add Money</h2>
                ...
                <div className="space-y-4">
                    <div>
                        <label htmlFor="amount" className="text-sm font-medium text-neutral-700 dark:text-neutral-300">Amount (USD)</label>
                     ...
                     <div>
                        ...
                        <div className="mt-1 w-full p-4 bg-neutral-100 dark:bg-neutral-800 border border-neutral-300 dark:border-neutral-700 rounded-lg">
                           <p className="font-semibold text-black dark:text-white">Bank of America</p>
                           <p className="text-xs text-neutral-500 dark:text-neutral-400">Checking •••• 1234</p>
                        </div>
                    </div>
                </div>
