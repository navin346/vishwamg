        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-end justify-center">
            <div className="w-full max-w-md bg-white dark:bg-slate-900 rounded-t-2xl p-6 shadow-xl animate-slide-up">
                <div className="flex justify-between items-center mb-4">
                    <h2 className="text-xl font-bold text-gray-900 dark:text-white">Withdraw</h2>
                ...
                {canWithdraw ? (
                    <>
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-gray-500 dark:text-neutral-400">Savings •••• {linkedAccounts.inr?.accountNumber.slice(-4)}</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="text-center py-4">
                         ...
                         <button onClick={onClose} className="w-full mt-6 bg-gray-200 dark:bg-slate-700 text-gray-800 dark:text-white font-bold py-3 px-4 rounded-lg">
                            OK
                         </button>
                    </div>
                )}
