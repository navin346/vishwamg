    ...
    const InputView = () => (
        <>
            <div className="bg-gray-100 dark:bg-neutral-800 p-3 rounded-lg mb-4">
                <p className="text-xs text-gray-500 dark:text-neutral-400">Sending to</p>
            ...
            <div className="w-full max-w-md bg-white dark:bg-slate-900 rounded-t-2xl p-6 shadow-xl animate-slide-up">
                <div className="flex justify-between items-center mb-4">
                    <div className="flex items-center gap-2">
                        ...
                        <h2 className="text-xl font-bold text-gray-900 dark:text-white">{view === 'contacts' ? 'Send To' : 'Send Money'}</h2>
                    </div>
