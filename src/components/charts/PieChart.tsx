                ...
                <svg viewBox="0 0 100 100" className="transform -rotate-90">
                 ...
                 {activeIndex !== null && (
                    <div className="absolute inset-0 flex flex-col items-center justify-center text-center pointer-events-none">
                        <span className="text-xs text-neutral-500 dark:text-neutral-400">{data[activeIndex].label}</span>
                        <span className="font-bold text-xl text-black dark:text-white">{currency}{data[activeIndex].value.toFixed(2)}</span>
                    </div>
                 )}
            </div>
                ...
                <ul className="space-y-2 text-sm">
                    {data.map((item, index) => (
                        ...
                        >
                            ...
                            <span className="font-semibold text-black dark:text-white">{((item.value / total) * 100).toFixed(0)}%</span>
                        </li>
                    ))}
                </ul>
            </div>
