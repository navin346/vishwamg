...
const BottomNav: React.FC<BottomNavProps> = ({ activePage, setActivePage }) => {
  return (
    <nav className="bg-white/90 dark:bg-black/90 backdrop-blur-xl border-t border-gray-100 dark:border-neutral-900 flex justify-between items-center h-[80px] pb-5 px-4 z-40 shadow-[0_-10px_40px_rgba(0,0,0,0.05)]">
