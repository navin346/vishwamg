    ...
    <div className="card-flip-container w-full h-56">
        <div className={`card-flipper w-full h-full ${isFlipped ? 'flipped' : ''}`}>
            <div className="card w-full h-full relative">
                {/* Card Front */}
                <div className="card-front absolute w-full h-full bg-surface rounded-2xl shadow-2xl p-6 flex flex-col justify-between text-white overflow-hidden border border-white/10">
                    <div className="absolute -top-1/2 -left-1/2 w-[200%] h-[200%] bg-gradient-to-br from-purple-500 via-pink-500 to-red-500 opacity-20 animate-gradient-pan" style={{ backgroundSize: '400% 400%' }}></div>
                    <div className="relative z-10 flex justify-between items-start">
                        <span className="font-semibold text-lg">VISHWAM</span>
                    ...
                    <div className="relative z-10 flex justify-between items-end font-mono text-sm">
                        <div>
                            <p className="text-xs uppercase text-subtle">Card Holder</p>
                            <p className="font-medium tracking-wider">{cardData.name}</p>
                        </div>
                        <div>
                            <p className="text-xs uppercase text-subtle">Expires</p>
                ...
                {/* Card Back */}
                <div className="card-back absolute w-full h-full bg-surface rounded-2xl shadow-2xl p-6 flex flex-col justify-between text-white border border-white/10">
                    <div className="w-full h-12 bg-black mt-4"></div>
                    <div className="bg-white/90 text-right p-2 rounded-md">
